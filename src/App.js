...
export default function App() {
  ...
  const connect = async () => {
    ...
    try {
      ...
      alert("Connection failed – open Coinbase Wallet and try again");
      console.error(e);
    }
  };
  ...
  const vacuum = () => {
    ...
    confetti({ particleCount: 200, spread: 90, origin: { y: 0.6 }, colors: ["#ff9500", "#ffb13b"] });
    alert(`Vacuumed ${total}¢ → ${total} Dust minted! You're in 4:20 draws.`);
  };
